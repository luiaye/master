...
if command -v ufw >/dev/null 2>&1; then
  ufw allow 33322/tcp || true
  ufw allow 33322/udp || true
elif command -v firewall-cmd >/dev/null 2>&1; then
  firewall-cmd --permanent --add-port=33322/tcp || true
  firewall-cmd --permanent --add-port=33322/udp || true
